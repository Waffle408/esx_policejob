...
AddEventHandler('esx_policejob:handcuff', function(target)
	...
	if xPlayer.job.name == 'police' then
		TriggerClientEvent('esx_policejob:getinfo', source)
	else
...
RegisterCommand('givelicense', function(source, cb)
	...
	for k, v in ipairs(players) do
	  ...
	  local xSource = ESX.GetPlayerFromId(source)
		...
		TriggerEvent('esx-license:checkLicense', v, 'weapon', function(cb)
		  if cb == false then 
			TriggerEvent('esx-license:addLicense', v, 'weapon', function()
			end)
			...
			TriggerClientEvent('esx-fines:Anim', source)
		  else
